	...
	<div class="container" style="width:auto;font-size:14px">
		...
		<article class="col-sm-9 maincontent" style="width:100%;">
		 <header class="page-header">
				<h1 class="page-title" style="text-align:center;">增加流程检查信息</h1>
...
<%--    	   <sf:option value="部分通过">部分通过</sf:option> --%>
   ...
   <td height="30" align="left">检查日期</td>
	...
	<td  align="center" colspan="2"><a
		href="/flowCheck/load.do" ><span class="btnold STYLE1"  style="width:70px; margin-bottom:10px;">返 回</span></a></td>	         
		  </tr>		
   </table>
</sf:form>
     	<p>&nbsp;</p>
