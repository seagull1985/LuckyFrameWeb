	...
	<div class="container" style="width:auto;font-size:14px">
		...
		<article class="col-sm-9 maincontent" style="width:100%;">
		 <header class="page-header">
				<h1 class="page-title" style="text-align:center;">添加版本信息</h1>
			</header>
...
<tr>
		  ...
		  <tr>
		  	<td height="30" align="left">代码规范问题(阻断)</td>
			  <td height="30" colspan="1"><sf:input path="codestandard_zd"
						...
						cssClass="error_msg" /> </td>
			<td height="30" align="left">代码规范问题(严重)</td>
		  ...
		  <tr>
		  	<td height="30" align="left">代码规范问题(主要)</td>
...
<%-- 		  <tr>
		  ...
		  <tr>
			  ...
			  <td height="30" colspan="3"><sf:textarea cols="100" rows="5" path="imprint"
						id="imprint"
						cssClass="easyui-validatebox" required="true"  data-options="validType:'minLength[0,248]'"  missingMessage="版本描述不能为空" invalidMessage="版本描述不能为空"  
			...
			<tr>
			  ...
			  <td height="30" colspan="4"><sf:textarea cols="100" rows="5" path="qualityreview"
						id="qualityreview"						
						cssClass="easyui-validatebox" data-options="validType:'minLength[0,248]'"  invalidMessage="质量回溯结果内容非法"  />&nbsp;<sf:errors path="qualityreview"
						cssClass="error_msg" /></td>
			</tr>
			 <tr>
