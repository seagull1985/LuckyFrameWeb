	...
	<div class="container" style="width:auto;font-size:14px">
		...
		<article class="col-sm-9 maincontent" style="width:100%;">
		 <header class="page-header">
				<h1 class="page-title" style="text-align:center;">修改评审信息</h1>
			</header>   
			
	<sf:form modelAttribute="review" method="post" onsubmit="return validTime(this)">
...
<tr>
		  ...
		  <tr>
			...
			<td height="30" colspan="1"><sf:input path="review_object"  id="review_object" 
						data-options="validType:'minLength[0,50]'"  missingMessage="评审对象" invalidMessage="评审对象"  />&nbsp;<sf:errors path="review_object"
						cssClass="error_msg" /> </td>
