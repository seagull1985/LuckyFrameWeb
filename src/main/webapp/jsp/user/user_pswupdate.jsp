	...
	<div class="container" style="width:auto;font-size:14px">
		...
		<article class="col-sm-9 maincontent" style="width:100%;">
		 <header class="page-header">
				<h1 class="page-title" style="text-align:center;">修改用户密码</h1>
			</header>   
			
					<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">修改用户密码</h3>

							<sf:form  modelAttribute="userinfo" method="post" >
							<div class="top-margin">
								<label>旧密码<span class="text-danger">*</span></label>
								<sf:input type="password" class="form-control" path="oldpassword" id="oldpassword"/>
							</div>
								...
								<div class="row top-margin">
									<div class="col-lg-4 text-center" style="width:900px">
										<button class="btn btn-action" type="submit">修改密码</button>
									</div>
								</div>
							</sf:form>
						</div>
