								...
								<div class="modal-body">
									<form class="form-horizontal" role="form">
										<div class="form-group">
											<label for="user_id" class="col-sm-3 control-label">项目名称</label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label for="lastname" class="col-sm-3 control-label">用例名称</label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label for="lastname" class="col-sm-3 control-label">用例类型</label>
											<div class="col-sm-9">
