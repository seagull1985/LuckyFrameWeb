...
<body>
	...
	<div class="container text-center">
		...
		<p class="text-muted" style="font-size:20px">
			&nbsp;&nbsp;&nbsp;&nbsp;LuckyFrame主要有测试计划管理、测试用例管理、任务调度管理、任务执行进度概况、用例执行情况以及日志定位、项目执行图表统计等功能，高度集成TestLink API,
			提供系统自带用例管理以及TestLink用例管理2种方式，通过用例关键字对自动化进行基本的测试分层(框架层，用例层，脚本层，数据层)驱动管理。
			全纬度支持接口自动化、UI自动化。质量管理模块目的是为了使QA的工作更加系统化、信息化，同时也能使项目管理人员及时掌握项目整体动态。
